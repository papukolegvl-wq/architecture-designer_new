...
const componentDescriptions: Record<ComponentType, { title: string; description: string; useCases: string[] }> = {
  ...
  'llm-model': {
    title: 'LLM Модель',
    description: 'Большая языковая модель (например, GPT, Claude, Llama). Служит ядром для генеративного ИИ, обработки естественного языка и решения интеллектуальных задач.',
    useCases: [
  ...
  'vector-database': {
    ...
    description: 'Специализированное хранилище для векторных представлений (embeddings). Ключевой компонент для реализации семантического поиска и систем RAG (Retrieval-Augmented Generation).',
    useCases: [
      'Семантический поиск и рекомендации',
      'Retrieval-Augmented Generation (RAG)',
      'Поиск по сходству изображений или текста',
      'Долгосрочная память для ИИ-агентов'
    ]
  },
  'ai-agent': {
    title: 'AI Агент / Оркестратор',
    description: 'Автономная система или слой управления, который использует LLM для планирования, выбора инструментов и выполнения последовательности действий для достижения цели.',
    useCases: [
  ...
  'ml-training': {
    ...
    description: 'Инфраструктура и пайплайны для обучения, дообучения (fine-tuning) и валидации моделей машинного обучения.',
    useCases: [
      'Обучение моделей на собственных данных',
      'Fine-tuning предобученных LLM',
      'A/B тестирование моделей',
      'Управление жизненным циклом моделей (MLOps)'
    ]
  },
  'ml-inference': {
    title: 'Инференс (Model Serving)',
    description: 'Специализированная среда или сервис для выполнения обученных моделей и предоставления предсказаний через API с низкой задержкой.',
    useCases: [
      'Хостинг и деплой нейросетей',
      'Real-time предсказания',
      'Масштабирование доступа к моделям',
      'Batch-инференс больших объемов данных'
    ]
  },
  'ml-data-pipeline': {
    title: 'ML Дата-пайплайн',
    description: 'Процессы подготовки данных, специфичные для машинного обучения: сбор, очистка, разметка, feature engineering и версионирование данных.',
    useCases: [
  ...
  'gpu-cluster': {
    title: 'GPU Кластер',
    description: 'Вычислительные ресурсы с графическими процессорами, оптимизированные для параллельных вычислений, необходимых при обучении и интенсивном инференсе моделей.',
    useCases: [
      'Обучение глубоких нейросетей',
      'Высокопроизводительный инференс',
      'Распределенные вычисления',
      'Обработка видео и тяжелой графики'
    ]
  }
}
