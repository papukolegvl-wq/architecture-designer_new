...
export const components: Component[] = [
  ...
  { type: 'browser-database', label: 'Браузерная БД', icon: <Database size={24} />, color: '#20c997', category: 'data' },
  { type: 'embedded-database', label: 'Встраиваемая БД', icon: <Database size={24} />, color: '#4dabf7', category: 'data' },
  { type: 'in-memory-database', label: 'In-memory БД', icon: <DatabaseZap size={24} />, color: '#fab005', category: 'data' },
  { type: 'log-database', label: 'База логов', icon: <FileText size={24} />, color: '#ffa94d', category: 'data' },

  // Elasticsearch Internals
  { type: 'es-node', label: 'ES Node', icon: <Server size={24} />, color: '#005571', category: 'data' },
  { type: 'es-index', label: 'ES Index', icon: <Database size={24} />, color: '#00BFB3', category: 'data' },
  { type: 'es-shard', label: 'ES Shard', icon: <Split size={24} />, color: '#1CA1C1', category: 'data' },
  { type: 'es-indexing-buffer', label: 'Indexing Buffer', icon: <DatabaseZap size={24} />, color: '#FBB040', category: 'data' },
  { type: 'es-translog', label: 'ES Translog', icon: <ScrollText size={24} />, color: '#005571', category: 'data' },
  { type: 'es-segment', label: 'ES Segment', icon: <Layers size={24} />, color: '#00BFB3', category: 'data' },
  { type: 'es-inverted-index', label: 'Inverted Index', icon: <Search size={24} />, color: '#1CA1C1', category: 'data' },
  { type: 'es-doc-values', label: 'Doc Values', icon: <TableIcon size={24} />, color: '#005571', category: 'data' },
  ...
  // --- AWS ---
  // Core Infrastructure
  { type: 'aws-region', label: 'AWS Region', icon: <Globe size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-az', label: 'AWS AZ', icon: <Grid size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'vpc', label: 'AWS VPC', icon: <Network size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'subnet', label: 'AWS Subnet', icon: <Grid size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'security-group', label: 'Security Group', icon: <Shield size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'internet-gateway', label: 'Internet Gateway', icon: <Globe size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'nat-gateway', label: 'NAT Gateway', icon: <Zap size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'route-table', label: 'Route Table', icon: <TableIcon size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'transit-gateway', label: 'Transit Gateway', icon: <Network size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'direct-connect', label: 'Direct Connect', icon: <LinkIcon size={24} />, color: '#FF9900', category: 'aws' },

  // Compute
  { type: 'aws-ec2', label: 'AWS EC2', icon: <Server size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-fargate', label: 'AWS Fargate', icon: <Layers size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-lambda', label: 'AWS Lambda', icon: <Zap size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-app-runner', label: 'AWS App Runner', icon: <Play size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-batch', label: 'AWS Batch', icon: <ListChecks size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-lightsail', label: 'AWS Lightsail', icon: <Server size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-outposts', label: 'AWS Outposts', icon: <Server size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-eks', label: 'AWS EKS (K8s)', icon: <Layers size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-ecs', label: 'AWS ECS', icon: <Box size={24} />, color: '#FF9900', category: 'aws' },

  // Storage
  { type: 'aws-s3', label: 'AWS S3', icon: <Box size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'ebs-volume', label: 'AWS EBS', icon: <HardDrive size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'efs-file-system', label: 'AWS EFS', icon: <Folders size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'glacier-vault', label: 'AWS Glacier', icon: <Archive size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-storage-gateway', label: 'Storage Gateway', icon: <Router size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-fsx', label: 'AWS FSx', icon: <HardDrive size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-snowball', label: 'AWS Snowball', icon: <Truck size={24} />, color: '#FF9900', category: 'aws' },

  // Databases
  { type: 'aws-rds', label: 'AWS RDS', icon: <Database size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-dynamodb', label: 'AWS DynamoDB', icon: <DatabaseZap size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-elasticache', label: 'AWS ElastiCache', icon: <HardDrive size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-neptune', label: 'AWS Neptune', icon: <Network size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-documentdb', label: 'AWS DocumentDB', icon: <FileJson size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-keyspaces', label: 'AWS Keyspaces', icon: <TableIcon size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-timestream', label: 'AWS Timestream', icon: <Clock size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-qldb', label: 'AWS QLDB', icon: <ClipboardList size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-redshift', label: 'AWS Redshift', icon: <Warehouse size={24} />, color: '#FF9900', category: 'aws' },

  // Networking & Content Delivery
  { type: 'aws-cloudfront', label: 'AWS CloudFront', icon: <Cloud size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-apigateway', label: 'AWS API Gateway', icon: <Zap size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-route53', label: 'AWS Route53', icon: <Globe size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-elb', label: 'AWS ELB/ALB', icon: <Split size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-app-mesh', label: 'AWS App Mesh', icon: <Network size={24} />, color: '#FF9900', category: 'aws' },

  // Security, Identity, & Compliance
  { type: 'iam-user', label: 'IAM User', icon: <User size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'iam-role', label: 'IAM Role', icon: <UserCheck size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'iam-group', label: 'IAM Group', icon: <Users size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'iam-policy', label: 'IAM Policy', icon: <ScrollText size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-kms', label: 'AWS KMS', icon: <Key size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-secrets-manager', label: 'Secrets Manager', icon: <Lock size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-certificate-manager', label: 'ACM', icon: <BadgeCheck size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-shield', label: 'AWS Shield', icon: <Shield size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-waf', label: 'AWS WAF', icon: <ShieldAlert size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-guardduty', label: 'AWS GuardDuty', icon: <ShieldCheck size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-inspector', label: 'AWS Inspector', icon: <Search size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-macie', label: 'AWS Macie', icon: <FileSearch size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-cognito', label: 'AWS Cognito', icon: <UserCheck size={24} />, color: '#FF9900', category: 'aws' },

  // Management & Governance
  { type: 'aws-cloudwatch', label: 'AWS CloudWatch', icon: <Activity size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-cloudtrail', label: 'AWS CloudTrail', icon: <ScrollText size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-config', label: 'AWS Config', icon: <Settings2 size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-systems-manager', label: 'Systems Manager', icon: <Settings size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-trusted-advisor', label: 'Trusted Advisor', icon: <CheckCircle2 size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-service-catalog', label: 'Service Catalog', icon: <Archive size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-backup', label: 'AWS Backup', icon: <HardDrive size={24} />, color: '#FF9900', category: 'aws' },

  // Analytics
  { type: 'aws-athena', label: 'AWS Athena', icon: <Pipette size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-emr', label: 'AWS EMR', icon: <BarChart3 size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-opensearch', label: 'AWS OpenSearch', icon: <Search size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-kinesis', label: 'AWS Kinesis', icon: <Zap size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-glue', label: 'AWS Glue', icon: <RefreshCw size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-lake-formation', label: 'Lake Formation', icon: <Warehouse size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-msk', label: 'AWS MSK (Kafka)', icon: <MessageSquare size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-quicksight', label: 'AWS QuickSight', icon: <BarChart3 size={24} />, color: '#FF9900', category: 'aws' },

  // Machine Learning
  { type: 'aws-sagemaker', label: 'AWS SageMaker', icon: <Brain size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-rekognition', label: 'Rekognition', icon: <Video size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-comprehend', label: 'Comprehend', icon: <FileText size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-lex', label: 'AWS Lex', icon: <MessageCircle size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-polly', label: 'AWS Polly', icon: <Speaker size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-transcribe', label: 'Transcribe', icon: <Mic size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-translate', label: 'Translate', icon: <Languages size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-forecast', label: 'AWS Forecast', icon: <BarChart3 size={24} />, color: '#FF9900', category: 'aws' },

  // Application Integration
  { type: 'aws-sqs', label: 'AWS SQS', icon: <MessageSquare size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-sns', label: 'AWS SNS', icon: <BellRing size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-step-functions', label: 'Step Functions', icon: <Workflow size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-eventbridge', label: 'EventBridge', icon: <Zap size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-appsync', label: 'AWS AppSync', icon: <Zap size={24} />, color: '#FF9900', category: 'aws' },

  // Developer Tools
  { type: 'aws-cloudformation', label: 'CloudFormation', icon: <FileCode size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-cdk', label: 'AWS CDK', icon: <Code2 size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-codecommit', label: 'CodeCommit', icon: <GitBranch size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-codebuild', label: 'CodeBuild', icon: <Construction size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-codedeploy', label: 'CodeDeploy', icon: <Rocket size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-codepipeline', label: 'CodePipeline', icon: <Workflow size={24} />, color: '#FF9900', category: 'aws' },
  { type: 'aws-xray', label: 'AWS X-Ray', icon: <Activity size={24} />, color: '#FF9900', category: 'aws' },
  ...
  { type: 'azure-service', label: 'Azure Table Storage', icon: <TableIcon size={24} />, color: '#0089D6', category: 'azure' },
  ...
  { type: 'oracle-goldengate', label: 'Oracle Golden Gate Sources', icon: <RefreshCcw size={24} />, color: '#F80000', category: 'oracle' },
