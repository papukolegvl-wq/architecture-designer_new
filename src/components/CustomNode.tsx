...
const componentIcons: Record<string, React.ReactNode> = {
  ...
  dbt: <DatabaseZap size={32} />,
  spark: <Zap size={32} />,
  airflow: <Workflow size={32} />,
  kafka: <Layers size={32} />,
  hadoop: <Database size={32} />,
  rbac: <ShieldCheck size={32} />,
  abac: <ShieldAlert size={32} />,
  iam: <UserCheck size={32} />,
  airbyte: <RefreshCw size={32} />,
  fivetran: <ArrowRight size={32} />,
  nifi: <Workflow size={32} />,
  dagster: <Activity size={32} />,
  prefect: <Rocket size={32} />,
  flink: <Zap size={32} />,
  snowflake: <Database size={32} />,
  databricks: <Box size={32} />,
  trino: <DatabaseZap size={32} />,
  'clickhouse-node': <Database size={32} />,
  bigquery: <Database size={32} />,
  'data-product': <Package size={32} />,
  'data-contract': <ScrollText size={32} />,
  mdm: <Users size={32} />,
  'data-masking': <EyeOff size={32} />,
  superset: <BarChart3 size={32} />,
  tableau: <BarChart3 size={32} />,
  powerbi: <BarChart3 size={32} />,
  looker: <Search size={32} />,
  metabase: <BarChart3 size={32} />,
  ...
  logic: <Workflow size={32} />,
  pattern: <Layers size={32} />,
  ...
  'oracle-goldengate': <RefreshCcw size={32} />,
  'es-node': <Server size={32} />,
  'es-index': <Database size={32} />,
  'es-shard': <Split size={32} />,
  'es-indexing-buffer': <DatabaseZap size={32} />,
  'es-translog': <ScrollText size={32} />,
  'es-segment': <Layers size={32} />,
  'es-inverted-index': <Search size={32} />,
  'es-doc-values': <TableIcon size={32} />,
  'browser-database': <Database size={32} />,
  'embedded-database': <Database size={32} />,
  'in-memory-database': <DatabaseZap size={32} />,
  'log-database': <FileText size={32} />,
  'aws-region': <Globe size={32} />,
  'aws-az': <Grid size={32} />,
  'iam-role': <UserCheck size={32} />,
  'iam-user': <User size={32} />,
  'iam-group': <Users size={32} />,
  'iam-policy': <ScrollText size={32} />,
  'route-table': <TableIcon size={32} />,
  'transit-gateway': <Network size={32} />,
  'direct-connect': <LinkIcon size={32} />,
  'elastic-ip': <Zap size={32} />,
  'autoscaling-group': <Scale size={32} />,
  'ebs-volume': <HardDrive size={32} />,
  'efs-file-system': <Folders size={32} />,
  'glacier-vault': <Archive size={32} />,
  'aws-fargate': <Layers size={32} />,
  'aws-app-runner': <Play size={32} />,
  'aws-batch': <ListChecks size={32} />,
  'aws-lightsail': <Server size={32} />,
  'aws-outposts': <Server size={32} />,
  'aws-storage-gateway': <Router size={32} />,
  'aws-fsx': <HardDrive size={32} />,
  'aws-snowball': <Truck size={32} />,
  'aws-elasticache': <HardDrive size={32} />,
  'aws-neptune': <Network size={32} />,
  'aws-documentdb': <FileJson size={32} />,
  'aws-keyspaces': <TableIcon size={32} />,
  'aws-timestream': <Clock size={32} />,
  'aws-qldb': <ClipboardList size={32} />,
  'aws-redshift': <Warehouse size={32} />,
  'aws-route53': <Globe size={32} />,
  'aws-app-mesh': <Network size={32} />,
  'aws-secrets-manager': <Lock size={32} />,
  'aws-certificate-manager': <BadgeCheck size={32} />,
  'aws-shield': <Shield size={32} />,
  'aws-guardduty': <ShieldCheck size={32} />,
  'aws-inspector': <Search size={32} />,
  'aws-macie': <FileSearch size={32} />,
  'aws-cloudtrail': <ScrollText size={32} />,
  'aws-config': <Settings2 size={32} />,
  'aws-systems-manager': <Settings size={32} />,
  'aws-xray': <Activity size={32} />,
  'aws-athena': <Pipette size={32} />,
  'aws-emr': <BarChart3 size={32} />,
  'aws-opensearch': <Search size={32} />,
  'aws-kinesis': <Zap size={32} />,
  'aws-glue': <RefreshCw size={32} />,
  'aws-lake-formation': <Warehouse size={32} />,
  'aws-msk': <MessageSquare size={32} />,
  'aws-quicksight': <BarChart3 size={32} />,
  'aws-sagemaker': <Brain size={32} />,
  'aws-rekognition': <Video size={32} />,
  'aws-comprehend': <FileText size={32} />,
  'aws-lex': <MessageCircle size={32} />,
  'aws-polly': <Speaker size={32} />,
  'aws-transcribe': <Mic size={32} />,
  'aws-translate': <Languages size={32} />,
  'aws-forecast': <BarChart3 size={32} />,
  'aws-step-functions': <Workflow size={32} />,
  'aws-eventbridge': <Zap size={32} />,
  'aws-appsync': <Zap size={32} />,
  'aws-cloudwatch': <Activity size={32} />,
  'aws-trusted-advisor': <CheckCircle2 size={32} />,
  'aws-service-catalog': <Archive size={32} />,
  'aws-backup': <HardDrive size={32} />,
  'aws-cloudformation': <FileCode size={32} />,
  'aws-cdk': <Code2 size={32} />,
  'aws-codecommit': <GitBranch size={32} />,
  'aws-codebuild': <Construction size={32} />,
  'aws-codedeploy': <Rocket size={32} />,
  'aws-codepipeline': <Workflow size={32} />,
  'aws-ec2': <Server size={32} />,
  'aws-s3': <Box size={32} />,
  'aws-rds': <Database size={32} />,
  'aws-dynamodb': <DatabaseZap size={32} />,
  'aws-sqs': <MessageSquare size={32} />,
  'aws-sns': <BellRing size={32} />,
  'aws-cloudfront': <Cloud size={32} />,
  'aws-apigateway': <Zap size={32} />,
  'aws-eks': <Layers size={32} />,
  'aws-ecs': <Box size={32} />,
  'aws-cognito': <UserCheck size={32} />,
  'aws-kms': <Key size={32} />,
  'aws-waf': <ShieldAlert size={32} />,
  'aws-elb': <Split size={32} />,
  'aws-iam': <UserCheck size={32} />,
  'oracle-service': <Cloud size={32} />,
  'aws-service': <Cloud size={32} />,
  'azure-service': <Cloud size={32} />,
  'gcp-service': <Cloud size={32} />,
  // IoT & Edge
  'iot-sensor': <Zap size={32} />,
  'iot-hub': <Network size={32} />,
  'edge-gateway': <Router size={32} />,
  'cdn-edge': <Globe size={32} />,
  'edge-worker': <Cpu size={32} />,
  'service-proxy': <Server size={32} />,
  'api-proxy': <Zap size={32} />,
  // Data
  'data-catalog': <Database size={32} />,
  'data-lineage': <GitBranch size={32} />,
  'data-source': <Database size={32} />,
  json: <FileJson size={32} />,
  xml: <FileCode size={32} />,
  // Infra
  'bare-metal': <Cpu size={32} />,
  'virtual-machine': <Server size={32} />,
  'security-group': <Shield size={32} />,
  'internet-gateway': <Globe size={32} />,
  'nat-gateway': <Zap size={32} />,
  // Dev
  monorepo: <Folders size={32} />,
  'micro-frontend': <Layout size={32} />,
  library: <Library size={32} />,
  // Monitoring
  dashboard: <Monitor size={32} />,
  'log-aggregator': <Terminal size={32} />,
  'metrics-collector': <Activity size={32} />,
  'synthetic-monitoring': <FlaskConical size={32} />,
  // Misc
  user: <User size={32} />,
  vendor: <Building2 size={32} />,
  'regulatory-body': <Scale size={32} />,
  // Branded
  postgresql: <Database size={32} />,
  mysql: <Database size={32} />,
  mongodb: <Database size={32} />,
  redis: <HardDrive size={32} />,
  elasticsearch: <Search size={32} />,
  cassandra: <Database size={32} />,
  mariadb: <Database size={32} />,
  clickhouse: <Database size={32} />,
  neo4j: <Network size={32} />,
  rabbitmq: <MessageSquare size={32} />,
  kubernetes: <Layers size={32} />,
  docker: <Box size={32} />,
  terraform: <Code size={32} />,
  jenkins: <GitBranch size={32} />,
  ansible: <Settings size={32} />,
  prometheus: <Activity size={32} />,
  grafana: <BarChart3 size={32} />,
  'aws-lambda': <Zap size={32} />,
}
...
export const componentColors: Record<string, string> = {
  ...
  databricks: '#fd7e14',
  trino: '#be4bdb',
  'clickhouse-node': '#fcc419',
  bigquery: '#4c6ef5',
  'data-product': '#ae3ec9',
  'data-contract': '#38d9a9',
  mdm: '#20c997',
  'data-masking': '#495057',
  superset: '#38d9a9',
  tableau: '#1c7ed6',
  ...
  'es-index': '#00BFB3',
  'es-shard': '#1CA1C1',
  'es-indexing-buffer': '#FBB040',
  'es-translog': '#005571',
  'es-segment': '#00BFB3',
  'es-inverted-index': '#1CA1C1',
  'es-doc-values': '#005571',
  'browser-database': '#20c997',
  ...
  'direct-connect': '#FF9900',
  'elastic-ip': '#FF9900',
  'autoscaling-group': '#FF9900',
  'ebs-volume': '#FF9900',
  'efs-file-system': '#FF9900',
  'glacier-vault': '#FF9900',
  'aws-fargate': '#FF9900',
  'aws-app-runner': '#FF9900',
  'aws-batch': '#FF9900',
  'aws-lightsail': '#FF9900',
  'aws-outposts': '#FF9900',
  'aws-storage-gateway': '#FF9900',
  'aws-fsx': '#FF9900',
  'aws-snowball': '#FF9900',
  'aws-elasticache': '#FF9900',
  'aws-neptune': '#FF9900',
  'aws-documentdb': '#FF9900',
  'aws-keyspaces': '#FF9900',
  'aws-timestream': '#FF9900',
  'aws-qldb': '#FF9900',
  'aws-redshift': '#FF9900',
  'aws-route53': '#FF9900',
  'aws-app-mesh': '#FF9900',
  'aws-secrets-manager': '#FF9900',
  'aws-certificate-manager': '#FF9900',
  'aws-shield': '#FF9900',
  'aws-guardduty': '#FF9900',
  'aws-inspector': '#FF9900',
  'aws-macie': '#FF9900',
  'aws-cloudtrail': '#FF9900',
  'aws-config': '#FF9900',
  'aws-systems-manager': '#FF9900',
  'aws-xray': '#FF9900',
  'aws-athena': '#FF9900',
  'aws-emr': '#FF9900',
  'aws-opensearch': '#FF9900',
  'aws-kinesis': '#FF9900',
  'aws-glue': '#FF9900',
  'aws-lake-formation': '#FF9900',
  'aws-msk': '#FF9900',
  'aws-quicksight': '#FF9900',
  'aws-sagemaker': '#FF9900',
  'aws-rekognition': '#FF9900',
  'aws-comprehend': '#FF9900',
  'aws-lex': '#FF9900',
  'aws-polly': '#FF9900',
  'aws-transcribe': '#FF9900',
  'aws-translate': '#FF9900',
  'aws-forecast': '#FF9900',
  'aws-step-functions': '#FF9900',
  'aws-eventbridge': '#FF9900',
  'aws-appsync': '#FF9900',
  'aws-cloudwatch': '#FF9900',
  'aws-trusted-advisor': '#FF9900',
  'aws-service-catalog': '#FF9900',
  'aws-backup': '#FF9900',
  'aws-cloudformation': '#FF9900',
  'aws-cdk': '#FF9900',
  'aws-codecommit': '#FF9900',
  'aws-codebuild': '#FF9900',
  'aws-codedeploy': '#FF9900',
  ...
  'aws-elb': '#FF9900',
  'aws-iam': '#FF9900',
  'oracle-service': '#F80000',
  'aws-service': '#FF9900',
  'azure-service': '#0089D6',
  'gcp-service': '#4285F4',
  // IoT & Edge
  'iot-sensor': '#ffd43b',
  'iot-hub': '#22b8cf',
  ...
  'bare-metal': '#444',
  'virtual-machine': '#666',
  'security-group': '#dc3545',
  'internet-gateway': '#51cf66',
  'nat-gateway': '#ffd43b',
  // Dev
  monorepo: '#adb5bd',
  'micro-frontend': '#22b8cf',
  library: '#748ffc',
  // Monitoring
  dashboard: '#f03e3e',
  'log-aggregator': '#fd7e14',
  'metrics-collector': '#ff6b6b',
  'synthetic-monitoring': '#ae3ec9',
  // Misc
  user: '#ff8787',
  vendor: '#adb5bd',
  'regulatory-body': '#12b886',
  // Branded
  postgresql: '#336791',
  mysql: '#00758F',
  mongodb: '#47A248',
...
function CustomNode({ data, selected, id, onInfoClick, onLinkClick, onLinkConfigClick, onCommentClick, onStatusChange, onColorChange }: CustomNodeProps) {
  ...
  const getSubtitle = () => {
    if (data.type === 'database' || data.type === 'browser-database' || data.type === 'embedded-database' || data.type === 'in-memory-database' || data.type === 'log-database') {
    ...
    >
          ...
          if (badgeId === 'kludge') {
            return (
              <div key="kludge" style={{
                ...
                fontSize: '10px',
                fontWeight: '900',
                boxShadow: '0 0 15px rgba(253, 126, 20, 0.4), 0 4px 10px rgba(0,0,0,0.5)',
                whiteSpace: 'nowrap',
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
      ...
      {data.type !== 'note' && (
        ...
        >
          ...
          {data.databaseConfig?.internalArchitecture?.components && data.databaseConfig.internalArchitecture.components.length > 0 && !isMedium && (
            <div style={{
              marginTop: '16px',
              width: '100%',
              display: 'flex',
              ...
              boxShadow: isDarkMode ? 'inset 0 0 15px rgba(0,0,0,0.3)' : 'inset 0 0 15px rgba(0,0,0,0.05)',
              ...
              <div style={{ 
                ...
                {data.databaseConfig.internalArchitecture.consistencyModel && (
                  <div style={{
                    fontSize: '8px',
                    padding: '2px 8px',
              ...
              <div style={{ 
                ...
                {[...data.databaseConfig.internalArchitecture.components].sort((a, b) => {
                  const order = { network: 1, cache: 2, log: 3, index: 4, disk: 5 };
                  ...
                  const getIcon = (type: string) => {
                    switch(type) {
                      ...
                      case 'index': return <Search size={14} />;
                    ...
                    <div key={comp.id} style={{
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ 
                          ...
                          marginBottom: comp.technologies?.length ? '2px' : '0'
                        }}>
                          {comp.label}
                        </div>
              ...
              {data.databaseConfig.internalArchitecture.storageStrategy && (
                <div style={{ 
                  marginTop: '6px', 
                  fontSize: '9px', 
                  color: mutedContentColor,
                  ...
                  fontWeight: '600'
                   ...
                   <span style={{ opacity: 0.8 }}>Storage Strategy:</span>
                   <span style={{ color: color }}>{data.databaseConfig.internalArchitecture.storageStrategy}</span>
                </div>
              )}
            </div>
          )}
