...
const vendors: Array<{ value: LoggingVendor; label: string; description: string }> = [
    { value: 'elastic-stack', label: 'ELK / Elastic Stack', description: 'Logstash, Elasticsearch, Kibana' },
    { value: 'fluentd', label: 'Fluentd / Fluent Bit', description: 'Unified logging layer' },
    { value: 'graylog', label: 'Graylog', description: 'Log management' },
    { value: 'splunk', label: 'Splunk', description: 'Data-to-Everything Platform' },
    { value: 'loki', label: 'Grafana Loki', description: 'Log aggregation by Grafana' },
    { value: 'datadog-logs', label: 'Datadog Logs', description: 'Cloud log management' },
    { value: 'aws-cloudwatch-logs', label: 'CloudWatch Logs', description: 'AWS Logs' },
    { value: 'google-cloud-logging', label: 'Cloud Logging', description: 'GCP Logs' },
    { value: 'rsyslog', label: 'Rsyslog', description: 'Standard syslog' },
]
        ...
        >
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button
                    ...
                    onMouseEnter={(e) => {
                        if (vendor) {
                            e.currentTarget.style.backgroundColor = '#ffc078'
                        }
                    }}
                    onMouseLeave={(e) => {
                        if (vendor) {
