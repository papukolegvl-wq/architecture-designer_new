...
export const componentDefinitions: Record<string, ComponentDefinition> = {
    ...
    'cdc-service': {
        title: 'CDC сервис (Change Data Capture)',
        description: 'Технология отслеживания изменений в БД в реальном времени (например, Debezium). Позволяет реагировать на изменения данных без нагрузки на БД.',
        useCases: [
            'Репликация данных в реальном времени',
            'Стриминг изменений в Kafka',
            'Обновление поисковых индексов и кешей',
            'Event-driven архитектура'
        ]
    },
    'data-quality': {
        title: 'Качество данных (Data Quality)',
        description: 'Инструменты для проверки точности, полноты и консистентности данных (например, Great Expectations, Soda). Обеспечивают доверие к данным.',
        useCases: [
            'Валидация данных в пайплайнах',
            'Мониторинг аномалий',
            'Проверка схем данных',
            'Отчетность о качестве данных'
        ]
    },
    'data-observability': {
        title: 'Observability данных',
        description: 'Системы мониторинга состояния данных и пайплайнов (например, Monte Carlo, Databand). Помогают быстро находить и устранять проблемы в данных.',
        useCases: [
            'Отслеживание lineage данных',
            'Детектирование инцидентов в данных',
            'Анализ влияния изменений',
            'Мониторинг SLA пайплайнов'
        ]
    },
    'metadata-catalog': {
        title: 'Каталог метаданных',
        description: 'Централизованный репозиторий для описания данных (например, DataHub, Amundsen). Обеспечивает discovery и поиск нужных данных.',
        useCases: [
            'Data Discovery',
    ...
    'reverse-etl': {
        title: 'Reverse ETL',
        description: 'Интеграция данных из хранилища (DWH) обратно в операционные системы: CRM, ERP, SaaS (например, Hightouch, Census).',
        useCases: [
            'Синхронизация сегментов в CRM',
            'Персонализация маркетинга',
            'Обогащение данных в SaaS сервисах',
            'Операционная аналитика'
        ]
    },
    'feature-store': {
        title: 'Feature Store',
        description: 'Хранилище признаков для машинного обучения (например, Feast, Tecton). Обеспечивает согласованность признаков между обучением и инференсом.',
        useCases: [
            'Централизованное хранение фичей',
            'Переиспользование фичей в моделях',
            'Online и offline доступ к признакам',
            'Управление версиями признаков'
        ]
    },
    'lakehouse': {
        title: 'Data Lakehouse',
        description: 'Архитектура, объединяющая гибкость Data Lake и производительность DWH (например, Databricks SQL, Snowflake). Поддерживает транзакции на файлах.',
        useCases: [
            'Аналитика на "сырых" данных',
            'Streaming и Batch аналитика в одном месте',
            'Масштабируемое хранение данных',
            'BI на основе файлов (Parquet, Delta)'
        ]
    },
    'dashboard': {
        title: 'Дашборд (Dashboard)',
        description: 'Интерфейс визуализации данных для мониторинга и анализа ключевых показателей в одном месте.',
        useCases: [
    ...
    'business-process': {
        title: 'Бизнес-процесс (Business Process)',
        description: 'Последовательность связанных задач или действий, которые приводят к достижению определенной бизнес-цели.',
        useCases: [
            'Моделирование бизнес-процессов',
            'Оптимизация рабочих процессов',
            'Визуализация операционной деятельности',
            'Документирование регламентов'
        ]
    },
    'vpc': {
        title: 'Виртуальная сеть (VPC)',
        description: 'Изолированный сегмент облака для размещения ресурсов с полным контролем над сетевой средой (IP-адреса, подсети, шлюзы).',
        useCases: [
            'Изоляция облачных ресурсов',
    ...
    'subnet': {
        ...
        description: 'Диапазон IP-адресов в составе VPC. Позволяет группировать ресурсы внутри изолированной сети.',
        useCases: [
            'Разделение на публичные и приватные сети',
            'Группировка ресурсов по назначению (Web, App, DB)',
            'Оптимизация маршрутизации'
        ]
    },
    'routing-table': {
        title: 'Таблица маршрутизации',
        description: 'Набор правил (маршрутов), определяющих, куда направляется сетевой трафик из вашей подсети или шлюза.',
        useCases: [
            'Управление трафиком внутри VPC',
            'Маршрутизация в интернет',
            'Настройка пиринговых соединений'
        ]
    },
    'internet-gateway': {
        title: 'Интернет-шлюз',
        description: 'Компонент VPC, который обеспечивает двусторонний доступ в интернет для ресурсов в публичных подсетях.',
        useCases: [
            'Доступ веб-серверов к интернету',
    ...
    'nat-gateway': {
        title: 'NAT-шлюз',
        description: 'Позволяет ресурсам в частных подсетях выходить в интернет (напр. для обновлений) без возможности входящих соединений извне.',
        useCases: [
            'Обновление ПО на приватных серверах',
            'Односторонний доступ в интернет',
            'Безопасное скачивание зависимостей'
        ]
    },
    'transit-gateway': {
        title: 'Транзитный шлюз',
        description: 'Центральный узел, соединяющий множество VPC и локальных сетей. Упрощает сетевую топологию и управление.',
        useCases: [
            'Связь между множеством VPC',
            'Подключение офисов к облаку',
            'Упрощение сетевой архитектуры на масштабе'
        ]
    },
    'direct-connect': {
        title: 'Выделенный канал (Direct Connect)',
        description: 'Выделенный физический сетевой канал связи между локальной инфраструктурой и облачным провайдером.',
        useCases: [
            'Гибридные облака',
            'Передача больших объемов данных',
            'Стабильное соединение с низкой задержкой'
        ]
    },
    'container-registry': {
        title: 'Реестр контейнеров',
        description: 'Хранилище артефактов для Docker/OCI образов контейнеров (например, Docker Hub, ECR, GCR).',
        useCases: [
    ...
    'waf': {
        ...
        description: 'Файрвол, работающий на уровне приложения (Layer 7). Защищает веб-приложения от распространенных атак (OWASP Top 10).',
        useCases: [
            'Защита от SQL Injection, XSS',
            'Фильтрация ботов',
            'Предотвращение атак на логин-формы'
        ]
    },
    'shield': {
        title: 'Защита от DDoS (Shield)',
        description: 'Управляемая служба защиты от DDoS-атак, обеспечивающая постоянное обнаружение и автоматическое отражение атак.',
        useCases: [
            'Защита доступности приложений',
            'Митигация объемных атак (L3/L4)',
            'Зеркалирование трафика для анализа'
        ]
    },
    'hsm': {
        title: 'Аппаратный модуль безопасности (HSM)',
        description: 'Выделенное физическое устройство для управления цифровыми ключами и выполнения криптографических операций.',
        useCases: [
            'Управление корневыми ключами CA',
            'Шифрование финансовых транзакций',
            'Соответствие строгим стандартам (FIPS 140-2)'
        ]
    },
    'kms': {
        title: 'Управление ключами (KMS)',
        description: 'Сервис создания и управления криптографическими ключами для шифрования данных в облачных сервисах.',
        useCases: [
            'Шифрование данных в S3/EBS',
            'Управление ключами шифрования',
            'Интеграция шифрования в приложения'
        ]
    },
    'iam-policy': {
        title: 'IAM Политика',
        description: 'Документ (обычно JSON), определяющий права доступа: кто (Who) может делать что (Action) с какими ресурсами (Resource).',
        useCases: [
    ...
    'security-group': {
        ...
        description: 'Виртуальный межсетевой экран на уровне инстанса. Контролирует входящий и исходящий трафик по портам и протоколам.',
        useCases: [
            'Открытие портов (80/443 для Web)',
            'Ограничение доступа по IP (SSH)',
            'Сегментация трафика между сервисами'
        ]
    },
    'soc-siem': {
        title: 'SOC / SIEM',
        description: 'Система управления информацией о безопасности и событиями. Собирает логи, анализирует угрозы и реагирует на инциденты.',
        useCases: [
    ...
    'block-storage': {
        ...
        description: 'Сетевое хранилище, предоставляющее данные в виде блоков (например, AWS EBS). Используется как "жесткий диск" для виртульных машин.',
        useCases: [
            'Системные диски OS',
            'Базы данных (высокий IOPS)',
            'Приложения требующие random access'
        ]
    },
    'file-storage': {
        title: 'Файловое хранилище (NAS)',
        description: 'Сетевое хранилище с доступом по файловым протоколам (NFS, SMB). Позволяет монтировать общие папки на множество серверов.',
        useCases: [
            'Общие директории для приложений',
    ...
    'archive-storage': {
        ...
        description: 'Дешевое хранилище для данных, к которым обращаются редко (например, AWS Glacier). Предназначено для долгосрочного хранения.',
        useCases: [
            'Юридически обязательное хранение логов',
    ...
    'payment-gateway': {
        ...
        description: 'Сервис для обработки онлайн-платежей (например, Stripe, PayPal). Обеспечивает безопасную передачу данных карт и транзакций.',
        useCases: [
            'Прием платежей на сайте/в приложении',
    ...
    'workflow-engine': {
        ...
        description: 'Система для управления сложными последовательными процессами (например, Temporal, Camunda, Airflow).',
        useCases: [
            'Оркестрация микросервисов',
            'Управление состоянием бизнес-процессов',
            'Длительные транзакции (Saga)'
        ]
    },
    'scheduler': {
        title: 'Планировщик задач',
        description: 'Служба для запуска задач по расписанию (Cron jobs). Управляет периодическим выполнением заданий.',
        useCases: [
            'Ежедневные отчеты',
    ...
    'state-machine': {
        ...
        description: 'Абстракция или сервис (например, AWS Step Functions), моделирующий переходы системы между конечным числом состояний.',
        useCases: [
            'Обработка заказов (Создан -> Оплачен -> Доставлен)',
            'Approval workflows',
    ...
    'crm': {
        title: 'CRM Система',
        description: 'Система управления взаимоотношениями с клиентами. Хранит данные о клиентах, сделках и коммуникациях.',
        useCases: [
    ...
    'erp': {
        title: 'ERP Система',
        description: 'Система планирования ресурсов предприятия. Объединяет данные о финансах, производстве, кадрах и складе.',
        useCases: [
    ...
    'billing-system': {
        title: 'Биллинг',
        description: 'Система тарификации и выставления счетов. Рассчитывает стоимость услуг и генерирует инвойсы.',
        useCases: [
    ...
    'data-mesh-node': {
        title: 'Узел Data Mesh',
        description: 'Автономный домен данных в архитектуре Data Mesh. Владеет своими данными, пайплайнами и предоставляет их как продукт.',
        useCases: [
    ...
    'data-governance': {
        ...
        description: 'Политики, процессы и инструменты для управления качеством, доступностью и безопасностью данных.',
        useCases: [
            'Контроль доступа к данным',
            'Обеспечение compliance (GDPR)',
            'Управление жизненным циклом данных'
        ]
    },
    'schema-registry': {
        title: 'Реестр схем',
        description: 'Сервис для хранения и версионирования схем данных (например, Avro Schemas для Kafka). Гарантирует совместимость форматов.',
        useCases: [
            'Валидация сообщений в Kafka',
            'Evolution схем данных',
            'Контрактное тестирование'
        ]
    },
    'master-data-management': {
        title: 'MDM Система',
        description: 'Система управления мастер-данными. Обеспечивает "единую версию правды" для критических бизнес-данных.',
        useCases: [
            'Уникальный профиль клиента (Golden Record)',
            'Справочники продуктов',
            'Классификаторы'
        ]
    },
    'media-transcoder': {
        title: 'Медиа-транскодер',
        description: 'Сервис для конвертации медиафайлов в различные форматы и разрешения (например, AWS Elemental MediaConvert).',
        useCases: [
            'Подготовка видео для стриминга',
    ...
    'media-streaming': {
        ...
        description: 'Сервис для потоковой передачи видео и аудио контента пользователям в реальном времени.',
        useCases: [
            'Live трансляции',
            'Video on Demand (VOD)',
            'Аудио-стриминг'
...
export function getComponentDefinition(type: string): ComponentDefinition {
    ...
    return {
        ...
        description: 'Описание для данного компонента пока отсутствует.',
        useCases: ['Общий компонент']
    }
}
