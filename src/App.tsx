...
function getComponentLabel(type: ComponentType): string {
  const labels: Record<ComponentType, string> = {
    ...
    'vpc': 'Виртуальная сеть (VPC)',
    'subnet': 'Подсеть',
    'routing-table': 'Таблица маршрутизации',
    'internet-gateway': 'Интернет-шлюз',
    'nat-gateway': 'NAT-шлюз',
    'transit-gateway': 'Транзитный шлюз',
    'direct-connect': 'Выделенный канал (Direct Connect)',
    'container-registry': 'Реестр контейнеров',
    'waf': 'WAF / Экран веб-приложений',
    'shield': 'Защита от DDoS (Shield)',
    'hsm': 'Аппаратный модуль безопасности (HSM)',
    'kms': 'Управление ключами (KMS)',
    'iam-policy': 'IAM Политика',
    'security-group': 'Группа безопасности',
    'soc-siem': 'SOC / SIEM комплекс',
    'block-storage': 'Блочное хранилище (EBS)',
    'file-storage': 'Файловое хранилище (EFS)',
    'archive-storage': 'Архивное хранилище (Glacier)',
    'payment-gateway': 'Платежный шлюз',
    'workflow-engine': 'Движок воркфлоу',
    'scheduler': 'Планировщик задач',
    'state-machine': 'Машина состояний',
    'crm': 'CRM система',
    'erp': 'ERP система',
    'billing-system': 'Биллинг',
    'data-mesh-node': 'Узел Data Mesh',
    'data-governance': 'Data Governance',
    'schema-registry': 'Реестр схем данных',
    'master-data-management': 'MDM система',
